      ...
      <div className="w-full">
        ...
        <div className="relative flex items-center">
          ...
          <input
            ...
            id={inputId}
            className={cn(
              'w-full rounded-btn border border-[var(--color-border)] bg-[var(--color-input-bg)] px-3 py-2.5 text-sm text-[var(--color-text-primary)] outline-none transition duration-200 placeholder:text-[var(--color-muted)] focus:border-[var(--color-primary-500)] focus:shadow-[0_0_0_3px_var(--color-focus-ring)]',
              leftIcon && 'pl-10',
              rightIcon && 'pr-10',
