...
const EXTRACT_ERROR_HINT: Record<string, string> = {
  ...
  missing_api_key: 'CV import is temporarily unavailable (server missing ANTHROPIC_API_KEY). Use the manual editor or contact support.',
  ai_extract_failed: 'AI could not structure your CV. Try again or use the manual editor.',
  extraction_failed: 'Import failed. Try again or use the manual editor.',
